...
func AddUser(currentPath string, roles []string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "\" data-on-load=\"document.querySelector(&#39;#add-user-dialog&#39;).show()\"><form method=\"post\" action=\"/admin/users\" data-on-submit=\"@post(&#39;/admin/users&#39;)\"><div class=\"space-y-4\"><sl-input label=\"Name\" required clearable data-bind-name><sl-icon slot=\"prefix\" name=\"person\"></sl-icon></sl-input> <sl-input label=\"Username\" required clearable data-bind-username><sl-icon slot=\"prefix\" name=\"person\"></sl-icon></sl-input> <sl-input type=\"password\" label=\"Password\" required password-toggle data-bind-password><sl-icon slot=\"prefix\" name=\"key\"></sl-icon></sl-input> <sl-select label=\"Role\" clearable help-text=\"Select role\" data-on-sl-input__case.kebab=\"$role = evt.target.value\"><sl-icon slot=\"prefix\" name=\"shield\"></sl-icon>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
