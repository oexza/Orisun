...
const file_eventstore_eventstore_proto_rawDesc = "" +
	...
	"\rrelated_query\x18\x03 \x01(\v2\x1e.eventstore.RelatedEventsQueryR\frelatedQuery\"w\n" +
	...
	"\x06stream\x18\x06 \x01(\v2\x1a.eventstore.GetStreamQueryR\x06stream\"\xb2\x02\n" +
	...
	"\fafterVersion\x18\x06 \x01(\x03R\fafterVersion*+\n" +
	"\tQueryType\x12\n" +
	"\n" +
	"\x06SIMPLE\x10\x00\x12\x12\n" +
	"\x0eRELATED_EVENTS\x10\x01*\x1e\n" +
	"\tDirection\x12\a\n" +
	"\x03ASC\x10\x00\x12\b\n" +
	"\x04DESC\x10\x012\xc0\x03\n" +
	"\n" +
	"EventStore\x12F\n" +
	"\n" +
	...
	"\x11GetEventsEnhanced\x12$.eventstore.GetEventsRequestEnhanced\x1a\x1d.eventstore.GetEventsResponse\"\x00\x12b\n" +
...
var file_eventstore_eventstore_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_eventstore_eventstore_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_eventstore_eventstore_proto_goTypes = []any{
	(QueryType)(0),                              // 0: eventstore.QueryType
	(Direction)(0),                              // 1: eventstore.Direction
	(*Position)(nil),                            // 2: eventstore.Position
	(*Tag)(nil),                                 // 3: eventstore.Tag
	(*Criterion)(nil),                           // 4: eventstore.Criterion
	(*Query)(nil),                               // 5: eventstore.Query
	(*RelatedEventsQuery)(nil),                  // 6: eventstore.RelatedEventsQuery
	(*EnhancedQuery)(nil),                       // 7: eventstore.EnhancedQuery
	(*EventToSave)(nil),                         // 8: eventstore.EventToSave
	(*Event)(nil),                               // 9: eventstore.Event
	(*WriteResult)(nil),                         // 10: eventstore.WriteResult
	(*SaveStreamQuery)(nil),                     // 11: eventstore.SaveStreamQuery
	(*SaveEventsRequest)(nil),                   // 12: eventstore.SaveEventsRequest
	(*GetStreamQuery)(nil),                      // 13: eventstore.GetStreamQuery
	(*GetEventsRequest)(nil),                    // 14: eventstore.GetEventsRequest
	(*GetEventsRequestEnhanced)(nil),            // 15: eventstore.GetEventsRequestEnhanced
	(*GetEventsResponse)(nil),                   // 16: eventstore.GetEventsResponse
	(*CatchUpSubscribeToEventStoreRequest)(nil), // 17: eventstore.CatchUpSubscribeToEventStoreRequest
	(*CatchUpSubscribeToStreamRequest)(nil),     // 18: eventstore.CatchUpSubscribeToStreamRequest
	(*timestamppb.Timestamp)(nil),               // 19: google.protobuf.Timestamp
}
var file_eventstore_eventstore_proto_depIdxs = []int32{
	3,  // 0: eventstore.Criterion.tags:type_name -> eventstore.Tag
	4,  // 1: eventstore.Query.criteria:type_name -> eventstore.Criterion
	4,  // 2: eventstore.RelatedEventsQuery.source_criterion:type_name -> eventstore.Criterion
	0,  // 3: eventstore.EnhancedQuery.type:type_name -> eventstore.QueryType
	5,  // 4: eventstore.EnhancedQuery.simple_query:type_name -> eventstore.Query
	6,  // 5: eventstore.EnhancedQuery.related_query:type_name -> eventstore.RelatedEventsQuery
	2,  // 6: eventstore.Event.position:type_name -> eventstore.Position
	19, // 7: eventstore.Event.date_created:type_name -> google.protobuf.Timestamp
	2,  // 8: eventstore.WriteResult.log_position:type_name -> eventstore.Position
	5,  // 9: eventstore.SaveStreamQuery.subsetQuery:type_name -> eventstore.Query
	11, // 10: eventstore.SaveEventsRequest.stream:type_name -> eventstore.SaveStreamQuery
	8,  // 11: eventstore.SaveEventsRequest.events:type_name -> eventstore.EventToSave
	5,  // 12: eventstore.GetEventsRequest.query:type_name -> eventstore.Query
	2,  // 13: eventstore.GetEventsRequest.from_position:type_name -> eventstore.Position
	1,  // 14: eventstore.GetEventsRequest.direction:type_name -> eventstore.Direction
	13, // 15: eventstore.GetEventsRequest.stream:type_name -> eventstore.GetStreamQuery
	7,  // 16: eventstore.GetEventsRequestEnhanced.enhanced_query:type_name -> eventstore.EnhancedQuery
	2,  // 17: eventstore.GetEventsRequestEnhanced.from_position:type_name -> eventstore.Position
	1,  // 18: eventstore.GetEventsRequestEnhanced.direction:type_name -> eventstore.Direction
	13, // 19: eventstore.GetEventsRequestEnhanced.stream:type_name -> eventstore.GetStreamQuery
	9,  // 20: eventstore.GetEventsResponse.events:type_name -> eventstore.Event
	2,  // 21: eventstore.CatchUpSubscribeToEventStoreRequest.afterPosition:type_name -> eventstore.Position
	5,  // 22: eventstore.CatchUpSubscribeToEventStoreRequest.query:type_name -> eventstore.Query
	5,  // 23: eventstore.CatchUpSubscribeToStreamRequest.query:type_name -> eventstore.Query
	12, // 24: eventstore.EventStore.SaveEvents:input_type -> eventstore.SaveEventsRequest
	14, // 25: eventstore.EventStore.GetEvents:input_type -> eventstore.GetEventsRequest
	15, // 26: eventstore.EventStore.GetEventsEnhanced:input_type -> eventstore.GetEventsRequestEnhanced
	17, // 27: eventstore.EventStore.CatchUpSubscribeToEvents:input_type -> eventstore.CatchUpSubscribeToEventStoreRequest
	18, // 28: eventstore.EventStore.CatchUpSubscribeToStream:input_type -> eventstore.CatchUpSubscribeToStreamRequest
	10, // 29: eventstore.EventStore.SaveEvents:output_type -> eventstore.WriteResult
	16, // 30: eventstore.EventStore.GetEvents:output_type -> eventstore.GetEventsResponse
	16, // 31: eventstore.EventStore.GetEventsEnhanced:output_type -> eventstore.GetEventsResponse
	9,  // 32: eventstore.EventStore.CatchUpSubscribeToEvents:output_type -> eventstore.Event
	9,  // 33: eventstore.EventStore.CatchUpSubscribeToStream:output_type -> eventstore.Event
