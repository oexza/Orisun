...
func Admin(currentPath string, title ...string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, "\"><sl-icon name=\"people\" class=\"mr-2\"></sl-icon> <span>Users</span></a></div></nav><div class=\"absolute bottom-0 w-64 p-4 border-t bg-white\"><sl-dropdown><sl-button slot=\"trigger\" variant=\"text\" size=\"small\" class=\"w-full\" caret><sl-icon slot=\"prefix\" name=\"person-circle\"></sl-icon> Profile</sl-button> <sl-menu><sl-menu-item><a href=\"/change-password\" onclick=\"event.preventDefault();\" data-on-click=\"@get('/change-password')\"><sl-icon slot=\"prefix\" name=\"key\"></sl-icon> Change Password</a></sl-menu-item> <sl-divider></sl-divider> <sl-menu-item><a href=\"/logout\"><sl-icon slot=\"prefix\" name=\"box-arrow-left\"></sl-icon> Logout</a></sl-menu-item></sl-menu></sl-dropdown></div></aside><!-- Main Content --><main class=\"flex-1 overflow-auto\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "<sl-dialog id=\"change-password-dialog\"></sl-dialog></main></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return nil
